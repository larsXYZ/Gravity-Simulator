...
const double PROJECTILE_DAMAGE_MASS_LIMIT = 120.0;
...
const double SHIELD_DRAIN_EXPLOSION = 30.0;
...
//EXPLODE PLANET
const float EXPLODE_PLANET_SPEEDMULT_OTHER = 0.05;
