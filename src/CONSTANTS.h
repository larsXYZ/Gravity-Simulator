...
const double TOV_LIMIT = 3300;                   // neutron star + mass → black hole
...
//UI
const int UI_SEPERATION_DISTANCE = 3; //SEPERATION OF UI ELEMENTS
...
const double NUMBER_OF_OBJECT_MULTIPLIER = 0.55;
